...
public class Utils {
	...
	public static class ParameterHandling {
		...
		public static void addParameterMouseListeners(Component component, SynthControlContainer container, int minVal, int maxVal, int valueStep, ReferenceWrapper<Integer> parameter, Procedure onChangeProcedure) {
